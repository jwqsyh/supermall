      ...
      <div class="shop-center-item shop-center-right">
        <table>
          <tr v-for="(item,index) in shop.score" :key="index">
            ...
            <td class="better" :class="{'better-more': item.isBetter}"><span>{{item.score ? '高' : '低'}}</span></td>
          </tr>
        </table>
      </div>
    </div>
...
<style scoped>
  ...
  .shop-center-right .better-more span {
